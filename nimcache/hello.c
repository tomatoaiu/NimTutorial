...
/* Command for C compiler:
   clang -c  -w  -I/usr/local/Cellar/nim/0.18.0_1/nim/lib -o /Users/tobashunsuke/Development/NimTutorial/nimcache/hello.o /Users/tobashunsuke/Development/NimTutorial/nimcache/hello.c */
...
NimStringDesc* world_nofn3q2FTFrk2UTvZ9ae7yg;
extern TNimType NTI_77mFvmsOLKik79ci2hXkHEg_;
extern TFrame* framePtr_HRfVMH3jYeBJz6Q6X9b6Ptw;
extern tyObject_GcHeap_1TRH1TZMaVZTnLNcIHuNFQ gch_IcYaEuuWivYAS86vFMTS3Q;
STRING_LITERAL(TM_xLHv575t3PG1lB5wK05Xqg_3, "world", 5);
STRING_LITERAL(TM_xLHv575t3PG1lB5wK05Xqg_4, "Hello", 5);
static N_NIMCALL(void, TM_xLHv575t3PG1lB5wK05Xqg_2)(void) {
	nimGCvisit((void*)world_nofn3q2FTFrk2UTvZ9ae7yg, 0);
}
...
nimRegisterGlobalMarker(TM_xLHv575t3PG1lB5wK05Xqg_2);
	nimln_(1, "hello.nim");
	T1_ = (NimStringDesc*)0;
	T1_ = world_nofn3q2FTFrk2UTvZ9ae7yg; world_nofn3q2FTFrk2UTvZ9ae7yg = copyStringRC1(((NimStringDesc*) &TM_xLHv575t3PG1lB5wK05Xqg_3));
	if (T1_) nimGCunrefNoCycle(T1_);
	nimln_(3, "hello.nim");
	memset((void*)T2_, 0, sizeof(T2_));
	T3_ = (NimStringDesc*)0;
	T3_ = rawNewString(world_nofn3q2FTFrk2UTvZ9ae7yg->Sup.len + 5);
appendString(T3_, ((NimStringDesc*) &TM_xLHv575t3PG1lB5wK05Xqg_4));
appendString(T3_, world_nofn3q2FTFrk2UTvZ9ae7yg);
	T2_[0] = T3_;
	echoBinSafe(T2_, 1);
	popFrame();
}
